...
// Initialize page and display high score
...
const updateHighScoreDisplay = () => {
  ...
  if (highScore !== null) {
    scoreDisplay.innerHTML = `<span>Your highest score is... ${highScore} movesâmore jars than Ollie's ever seen on a sunny day!`;
  } else {
    scoreDisplay.innerHTML = `<span>You haven't stacked any jars yetâbut the pantry's waiting, champ!</span>`;
  }
};
...
const showTimeUpMessage = () => {
  ...
  timeUpMessage.innerHTML = `
    <div class="message-content">
      ...
      <h2>Aww, time's up! But that's okayâevery great baker needs a little practice! Wanna roll up your sleeves and give it another go? I believe in ya, cookie champ!</h2>
      <a href="page-levels.html" id="go-back"><img class="button-goback" src="images/button-goback.png"></a>
      <a href="page-score.html" id="hi-score"><img class="button-hiscore" src="images/button-hiscore.png"></a>
    </div>
  `;
